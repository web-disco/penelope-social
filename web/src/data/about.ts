...
export const aboutPage = {
  ...
  paragraphs: [
    // HTML: "pizza" links to the /pizza-vaughan landing page.
    'A cafe and bar in Woodbridge, Vaughan. Cafe by day, kitchen and bar at night. Bakehouse sourdough on the table as sandwiches and <a href="/pizza-vaughan">pizza</a>, or as bread.',
  ...
  videoTeaser: {
    ...
    body: 'Vince’s starter still works the dough, and we serve that bread here as sandwiches and pizza, and as loaves.',
